...
public class MyFussballBundesliga {
	...
	public static void addMyFussballBundesliga(FotoKalender cal) {
		...
		addTermin(cal,17,10,17,10, 2025, "1. FC Union Berlin - Borussia M\u00F6nchengladbach");
		...
		addTermin(cal,29,10,29,10, 2025, "1. FC Union Berlin - Arminia Bielefeld");
		...
		addTermin(cal, 1,11,01,11, 2025, "1. FC Union Berlin - Sport-Club Freiburg");
		...
		addTermin(cal,8,11,8,11, 2025, "1. FC Union Berlin - FC Bayern M\u00FCnchen");
		...
		addTermin(cal,29,11,29,11, 2025, "1. FC Union Berlin - 1. FC Heidenheim 1846");
		addTermin(cal,28,11,30,11, 2025, "TSG Hoffenheim - FC Augsburg");
		addTermin(cal,28,11,30,11, 2025, "Hamburger SV - VfB Stuttgart");

        //DFB Pokal 3. Runde
        addTermin(cal,3,12,3,12, 2025, "1. FC Union Berlin - FC Bayern M\u00FCnchen");
		...
		addTermin(cal,12,12,12,12, 2025, "1. FC Union Berlin - RB Leipzig");
		...
		addTermin(cal,10,1,10,1, 2026, "1. FC Union Berlin - 1. FSV Mainz 05");
		...
		addTermin(cal,24,1,24,1, 2026, "1. FC Union Berlin - Borussia Dortmund");
		...
		if (cal.THIS_YEAR >= 2026) {
			...
			PersonalDate sp;
            GregorianCalendar spieltag1 = new GregorianCalendar(cal.THIS_YEAR, Calendar.AUGUST, 28);
            if (cal.THIS_YEAR > 2026) {
                // Probably expected start days in future:
                spieltag1.add(Calendar.WEEK_OF_YEAR, (cal.THIS_YEAR - 2026)*52);
            }
			sp = PersonalDate.create2BitmapsBackground(new File("res/FC Bayern M\u00FCnchen.jpg"), " ... ", new File("res/RB Leipzig.png"), 0.7f, 0f, spieltag1);
			cal.mDates.addCalEvent(sp);
            spieltag1.add(Calendar.DAY_OF_MONTH, 1);
			sp = PersonalDate.create2BitmapsBackground(new File("res/Bayer Leverkusen.png"), " ... ", new File("res/Borussia M\u00F6nchengladbach.jpg"), 0.7f, 0f, spieltag1);
			cal.mDates.addCalEvent(sp);
			sp = PersonalDate.create2BitmapsBackground(new File("res/BVB 09 Dortmund.jpg"), "? ... ", new File("res/UnionBerlin.png"), 0.7f, 0.5f, spieltag1);
			cal.mDates.addCalEvent(sp);
		}
	...
	public static void addTermin(
		...
		if (selHin != null && selRuek != null) {
			System.out.println("Ausgew�hltes Spiel: "+ selHin.mStrIcoName +" - "+ selRuek.mStrIcoName);
